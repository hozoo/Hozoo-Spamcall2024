...
╚═╝░░╚═╝░╚════╝░╚══════╝░╚════╝░░╚════╝░
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Author{R}:{W}HOZOO          │ Version {R}:{G} 3.0{W}             │
  {W}| Addition{R}:{W}HACKERSHOZOO    |                        {W}   |
  {W}│ Github{R}:{G}github.com/hozoo  {W}│ {W}Your Ip {R}:{Y} {ip}      {W}│
  {W}│ Tiktok{R}:{W}HACKERSHOZOORAFI {biru}FOLLOW         {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
def banner2():
    print (f"""{putih}           ┌───────────────────┴─────────┬──────────┐
           ...
           {putih}│ 3{R}.{W}GRUP INDONESIAN REVOLUTION CYBER           │{G}  Online  {W}│
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "2":
        ...
        tanya()
    if pil == "3":
        os.system("xdg-open https://chat.whatsapp.com/GEZIt7DGezSJlaDJE37GTy ")
